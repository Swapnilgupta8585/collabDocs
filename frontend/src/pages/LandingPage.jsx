        ...
        <div className="max-w-7xl mx-auto px-8 py-4 flex justify-between items-center">
          ...
          <div className="flex items-center gap-4 " >
            <div className="hover:scale-110 transition shadow-lg" >
              <Link
                to="/login"
                className="text-base px-5 py-2 rounded-full border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-200 bg-gray-100 dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600 "
              >
                Sign In
              </Link>
            </div>
            <div  className=" hover:scale-110 transition shadow-lg">
              <Link
                to="/register"
                className="text-base px-5 py-2 rounded-full bg-blue-600 dark:bg-blue-500 text-white font-semibold shadow hover:bg-blue-700 dark:hover:bg-blue-600"
              >
                Sign Up
              </Link>
            </div>
